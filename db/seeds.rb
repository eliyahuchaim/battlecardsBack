...
# user = User.first
#
# character2 = Character.create(user_id: user.id, name: "first character", avatar: "hi")
#
# user.weapon_cards[0].update(character_id: character.id)
# user.weapon_cards[1].update(character_id: character.id)
# user.weapon_cards[98].update(character_id: character2.id)
#
# user.vehicle_cards[1].update(character_id: character2.id)
# user.class_cards[1].update(character_id: character2.id)
